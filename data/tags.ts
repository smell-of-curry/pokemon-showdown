...
export const Tags: { [id: IDEntry]: TagData } = {
  ...
  nonsnatchable: {
    ...
    moveFilter: move =>
      ['allyTeam', 'self', 'adjacentAllyOrSelf'].includes(move.target) &&
  ...
  duber: {
    name: 'DUber',
    speciesFilter: species =>
      species.doublesTier === 'DUber' || species.doublesTier === '(DUber)',
  },
  dou: {
    name: 'DOU',
    speciesFilter: species =>
      species.doublesTier === 'DOU' || species.doublesTier === '(DOU)',
  },
  dbl: {
    name: 'DBL',
  ...
  nduber: {
    name: 'ND Uber',
    speciesFilter: species =>
      species.natDexTier === 'Uber' || species.natDexTier === '(Uber)',
  },
  ndou: {
    name: 'ND OU',
    speciesFilter: species =>
      species.natDexTier === 'OU' || species.natDexTier === '(OU)',
  },
  nduubl: {
    name: 'ND UUBL',
