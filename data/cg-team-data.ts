...
export const ABILITY_MOVE_BONUSES: {
  [abilityID: IDEntry]: { [moveID: IDEntry]: number };
} = {
  drought: { sunnyday: 0.2, solarbeam: 2 },
  contrary: { terablast: 2 },
};
// Bonuses to move ratings by move type
export const ABILITY_MOVE_TYPE_BONUSES: {
  [abilityID: IDEntry]: { [typeName: string]: number };
} = {
  darkaura: { Dark: 1.33 },
...
export const WEIGHT_BASED_MOVES = [
  'heatcrash',
  'heavyslam',
  'lowkick',
  'grassknot',
