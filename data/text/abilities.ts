export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
  ...
  hospitality: {
    name: 'Hospitality',
    shortDesc:
      "On switch-in, this Pokemon restores 1/4 of its ally's maximum HP, rounded down.",
  ...
  mindseye: {
    ...
    shortDesc:
      "Fighting, Normal moves hit Ghost. Accuracy can't be lowered, ignores evasiveness.",
  },
  minus: {
    name: 'Minus',
  ...
  poisonpuppeteer: {
    ...
    shortDesc:
      'Pecharunt: If this Pokemon poisons a target, the target also becomes confused.',
  },
  poisontouch: {
    name: 'Poison Touch',
  ...
  terashift: {
    name: 'Tera Shift',
    shortDesc:
      'If this Pokemon is a Terapagos, it transforms into its Terastal Form on entry.',
