export const ItemsText: { [id: IDEntry]: ItemText } = {
  abilityshield: {
    name: 'Ability Shield',
    shortDesc:
      "Holder's Ability cannot be changed, suppressed, or ignored by any effect.",
  ...
  absolite: {
    name: 'Absolite',
    shortDesc:
      'If held by an Absol, this item allows it to Mega Evolve in battle.',
  },
  absorbbulb: {
    name: 'Absorb Bulb',
    shortDesc:
  ...
  banettite: {
    name: 'Banettite',
    shortDesc:
      'If held by a Banette, this item allows it to Mega Evolve in battle.',
  },
  beastball: {
    name: 'Beast Ball',
  ...
  buginiumz: {
    name: 'Buginium Z',
    shortDesc:
      'If holder has a Bug move, this item allows it to use a Bug Z-Move.',
  },
  burndrive: {
    name: 'Burn Drive',
  ...
  cherishball: {
    name: 'Cherish Ball',
    shortDesc:
      'A rare Poke Ball that has been crafted to commemorate an occasion.',
  },
  chestoberry: {
    name: 'Chesto Berry',
  ...
  cornerstonemask: {
    ...
    shortDesc:
      'Ogerpon-Cornerstone: 1.2x power attacks; Terastallize to gain Embody Aspect.',
  },
  cornnberry: {
    name: 'Cornn Berry',
    shortDesc:
  ...
  darkiniumz: {
    name: 'Darkinium Z',
    shortDesc:
      'If holder has a Dark move, this item allows it to use a Dark Z-Move.',
  },
  dawnstone: {
    name: 'Dawn Stone',
  ...
  dreamball: {
    name: 'Dream Ball',
    shortDesc:
      "A Poke Ball that makes it easier to catch wild Pokémon while they're asleep.",
    gen7: {
      shortDesc:
  ...
  eeviumz: {
    name: 'Eevium Z',
    shortDesc:
      'If held by an Eevee with Last Resort, it can use Extreme Evoboost.',
  },
  ejectbutton: {
    name: 'Eject Button',
    shortDesc:
  ...
  firiumz: {
    name: 'Firium Z',
    shortDesc:
      'If holder has a Fire move, this item allows it to use a Fire Z-Move.',
  },
  fistplate: {
    name: 'Fist Plate',
    shortDesc:
  ...
  fossilizedbird: {
    ...
    shortDesc:
      'Can revive into Dracozolt with Fossilized Drake or Arctozolt with Fossilized Dino.',
  },
  fossilizeddino: {
    name: 'Fossilized Dino',
    shortDesc:
      'Can revive into Arctovish with Fossilized Fish or Arctozolt with Fossilized Bird.',
  },
  fossilizeddrake: {
    name: 'Fossilized Drake',
    shortDesc:
      'Can revive into Dracozolt with Fossilized Bird or Dracovish with Fossilized Fish.',
  },
  fossilizedfish: {
    name: 'Fossilized Fish',
    shortDesc:
      'Can revive into Dracovish with Fossilized Drake or Arctovish with Fossilized Dino.',
  },
  friendball: {
    name: 'Friend Ball',
  ...
  galladite: {
    name: 'Galladite',
    shortDesc:
      'If held by a Gallade, this item allows it to Mega Evolve in battle.',
  },
  ganlonberry: {
    name: 'Ganlon Berry',
    shortDesc:
  ...
  garchompite: {
    name: 'Garchompite',
    shortDesc:
      'If held by a Garchomp, this item allows it to Mega Evolve in battle.',
  },
  gardevoirite: {
    name: 'Gardevoirite',
    shortDesc:
  ...
  gengarite: {
    name: 'Gengarite',
    shortDesc:
      'If held by a Gengar, this item allows it to Mega Evolve in battle.',
  },
  ghostgem: {
    name: 'Ghost Gem',
    shortDesc:
  ...
  glalitite: {
    name: 'Glalitite',
    shortDesc:
      'If held by a Glalie, this item allows it to Mega Evolve in battle.',
  },
  goldbottlecap: {
  ...
  iciumz: {
    name: 'Icium Z',
    shortDesc:
      'If holder has an Ice move, this item allows it to use an Ice Z-Move.',
  },
  icyrock: {
    name: 'Icy Rock',
  ...
  kommoniumz: {
    name: 'Kommonium Z',
    shortDesc:
      'If held by a Kommo-o with Clanging Scales, it can use Clangorous Soulblaze.',
  },
  laggingtail: {
    name: 'Lagging Tail',
    shortDesc: 'Holder moves last in its priority bracket.',
  ...
  latiosite: {
    name: 'Latiosite',
    shortDesc:
      'If held by a Latios, this item allows it to Mega Evolve in battle.',
  },
  laxincense: {
    name: 'Lax Incense',
    shortDesc: 'The accuracy of attacks against the holder is 0.9x.',
  ...
  lopunnite: {
    name: 'Lopunnite',
    shortDesc:
      'If held by a Lopunny, this item allows it to Mega Evolve in battle.',
  },
  loveball: {
    name: 'Love Ball',
    shortDesc:
  ...
  lucarionite: {
    name: 'Lucarionite',
    shortDesc:
      'If held by a Lucario, this item allows it to Mega Evolve in battle.',
  },
  luckypunch: {
    name: 'Lucky Punch',
    shortDesc:
  ...
  lunaliumz: {
    name: 'Lunalium Z',
    shortDesc:
      'Lunala or Dawn Wings Necrozma with Moongeist Beam can use a special Z-Move.',
  },
  lureball: {
    name: 'Lure Ball',
  ...
  lycaniumz: {
    name: 'Lycanium Z',
    shortDesc:
      'If held by a Lycanroc forme with Stone Edge, it can use Splintered Stormshards.',
  },
  machobrace: {
    name: 'Macho Brace',
    shortDesc:
  ...
  masterpieceteacup: {
    ...
    shortDesc:
      'Evolves Poltchageist-Artisan into Sinistcha-Masterpiece when used.',
  },
  mawilite: {
    name: 'Mawilite',
    shortDesc:
      'If held by a Mawile, this item allows it to Mega Evolve in battle.',
  },
  meadowplate: {
    name: 'Meadow Plate',
    shortDesc:
  ...
  mewtwonitex: {
    name: 'Mewtwonite X',
    shortDesc:
      'If held by a Mewtwo, this item allows it to Mega Evolve in battle.',
  },
  mewtwonitey: {
    name: 'Mewtwonite Y',
    shortDesc:
  ...
  mimikiumz: {
    name: 'Mimikium Z',
    shortDesc:
      "If held by a Mimikyu with Play Rough, it can use Let's Snuggle Forever.",
  },
  mindplate: {
    name: 'Mind Plate',
    shortDesc:
  ...
  ovalstone: {
    name: 'Oval Stone',
    shortDesc:
      'Evolves Happiny into Chansey when held and leveled up during the day.',
  },
  pamtreberry: {
    name: 'Pamtre Berry',
    shortDesc:
  ...
  pidgeotite: {
    name: 'Pidgeotite',
    shortDesc:
      'If held by a Pidgeot, this item allows it to Mega Evolve in battle.',
  },
  pikaniumz: {
    name: 'Pikanium Z',
    shortDesc:
      'If held by a Pikachu with Volt Tackle, it can use Catastropika.',
  },
  pikashuniumz: {
    name: 'Pikashunium Z',
    shortDesc:
  ...
  pinsirite: {
    name: 'Pinsirite',
    shortDesc:
      'If held by a Pinsir, this item allows it to Mega Evolve in battle.',
  },
  pixieplate: {
    name: 'Pixie Plate',
    shortDesc:
  ...
  premierball: {
    name: 'Premier Ball',
    shortDesc:
      'A rare Poke Ball that has been crafted to commemorate an event.',
  },
  primariumz: {
    name: 'Primarium Z',
    shortDesc:
  ...
  rockiumz: {
    name: 'Rockium Z',
    shortDesc:
      'If holder has a Rock move, this item allows it to use a Rock Z-Move.',
  },
  rockyhelmet: {
    name: 'Rocky Helmet',
    shortDesc:
  ...
  sablenite: {
    name: 'Sablenite',
    shortDesc:
      'If held by a Sableye, this item allows it to Mega Evolve in battle.',
  },
  sachet: {
    name: 'Sachet',
  ...
  sceptilite: {
    name: 'Sceptilite',
    shortDesc:
      'If held by a Sceptile, this item allows it to Mega Evolve in battle.',
  },
  scizorite: {
    name: 'Scizorite',
    shortDesc:
      'If held by a Scizor, this item allows it to Mega Evolve in battle.',
  },
  scopelens: {
    name: 'Scope Lens',
    shortDesc: "Holder's critical hit ratio is raised by 1 stage.",
  ...
  shedshell: {
    name: 'Shed Shell',
    shortDesc:
      'Holder cannot be prevented from choosing to switch out by any effect.',
  },
  shellbell: {
    name: 'Shell Bell',
    shortDesc:
  ...
  slowbronite: {
    name: 'Slowbronite',
    shortDesc:
      'If held by a Slowbro, this item allows it to Mega Evolve in battle.',
  },
  smoothrock: {
    name: 'Smooth Rock',
  ...
  solganiumz: {
    name: 'Solganium Z',
    shortDesc:
      'Solgaleo or Dusk Mane Necrozma with Sunsteel Strike can use a special Z-Move.',
  },
  souldew: {
    name: 'Soul Dew',
    shortDesc:
  ...
  ultranecroziumz: {
    ...
    shortDesc:
      'Dusk Mane/Dawn Wings Necrozma: Ultra Burst, then Z-Move w/ Photon Geyser.',
