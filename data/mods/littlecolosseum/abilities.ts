export const Abilities: import('../../../sim/dex-abilities').ModdedAbilityDataTable =
  {
    ...
    entertainer: {
      ...
      name: 'Entertainer',
      shortDesc:
        "This Pokemon's type changes to the type of the move it is using.",
      rating: 4,
      num: -168,
    },
    spikedfur: {
      ...
      rating: 2.5,
      shortDesc:
        'Pokemon that use moves with ≤60 BP against this Pokemon lose 1/8 of their max HP.',
    },
    galewings: {
    ...
    stall: {
      ...
      flags: {},
      shortDesc:
        "This Pokemon's status moves are used twice, but it usually moves last.",
      name: 'Stall',
      rating: 1,
      num: 100,
    },
